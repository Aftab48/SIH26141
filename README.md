...
`sih141.protocol.analysis`, which contains closed forms only and no simulation. The long form,
with each bound set against what was actually measured, is [docs/SECURITY.md](docs/SECURITY.md).
...
| 7 | Submission docs: mathematical modelling, security analysis, attack record | ✅ Complete |

> **Phase 7 is three documents, and they are the ones to read first.**
> [docs/MODELLING.md](docs/MODELLING.md) states the protocol as mathematics, with every bound
> traced to the inequality it rests on. [docs/SECURITY.md](docs/SECURITY.md) sets what is proven
> beside what is measured, property by property, and gives the headline limitation its own
> section. [docs/ATTACKS.md](docs/ATTACKS.md) is the full record of every adversary run against
> the protocol. Each owns its own material and cites the other two, and none of them replaces
> [docs/PHASE1.md](docs/PHASE1.md) through [docs/PHASE6.md](docs/PHASE6.md), which stay as the
> engineering record.
>
...
docs/              engineering notes per phase
  MODELLING.md     Phase 7: the protocol as mathematics
  SECURITY.md      Phase 7: proven against measured, property by property
  ATTACKS.md       Phase 7: every adversary run against the protocol
