...
| --- | --- | --- | --- | --- | --- | --- | --- |
| clean | before-forwarding | 30 | 60 | 60 | 0 | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| clean | before-forwarding | honest | 30 | 0 | no trials | 0/30 = 0.000 [0.000, 0.181] | 0 | 3.396e-10 | yes | not evaluated (1) |
...
- Families withheld on at least one run in this table, reported as `not evaluated` and never as passed: channel:Bob/1:chsh, channel:Charlie/1:chsh.
